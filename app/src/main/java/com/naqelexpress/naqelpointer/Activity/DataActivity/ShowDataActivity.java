        ...
        extends MainActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SpinnerDialog = new SpinnerDialog(GlobalVar.GV().activity,GlobalVar.GV().StationNameList ,"Select or Search Dat aType",R.style.DialogAnimations_SmileWindow);
    }

    private void ShowData()
    {
        DataList = new ArrayList<>();
        Cursor result = GlobalVar.GV().dbConnections.Fill("select * from OnDelivery");
