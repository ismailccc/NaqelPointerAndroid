...
public class DeliverySheet extends AppCompatActivity implements ListViewRoute.sendMapData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbConnections.deleteDeliverysheetExceptByToday(getWindow().getDecorView().getRootView());
            ...
            if (finalJson != null) { // 17099
                ...
                try {
                    if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION)
                        ...
                        if (location != null) {
                            new MyRouteShipmentsNew(finalJson, String.valueOf(location.getLatitude()),
                                    String.valueOf(location.getLongitude()), getApplicationContext(),
                                    getWindow().getDecorView().getRootView());
                        } else
                            new MyRouteShipmentsNew(finalJson, "0", "0", getApplicationContext(),
                                    getWindow().getDecorView().getRootView());
                    }
