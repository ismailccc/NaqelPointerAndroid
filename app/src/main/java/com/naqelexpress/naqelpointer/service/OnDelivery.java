...
public class OnDelivery extends Service {
        ...
        try {
            ...
            if (result.getCount() > 0) {
                ...
                if (result.moveToFirst()) {
                    ...
                    if (resultDetail.getCount() > 0) {
                        ...
                        do {
                            onDeliveryRequest.OnDeliveryDetailRequestList.add(index,
                                    new OnDeliveryDetailRequest(resultDetail.getString(resultDetail.getColumnIndex("BarCode"))));
                            index++;
                        }
                    ...
                    SaveOnDelivery(db, jsonData, onDeliveryRequest.ID);
                }
    ...
    public void SaveOnDelivery(final DBConnections db, final String input, final int id) {
