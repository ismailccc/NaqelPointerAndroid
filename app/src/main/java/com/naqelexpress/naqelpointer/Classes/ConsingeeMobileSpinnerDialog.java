...
public class ConsingeeMobileSpinnerDialog
{
    ...
    public ConsingeeMobileSpinnerDialog(Activity activity, String firstPhoneNo,String secondPhoneNo)
    {
    ...
    public void showSpinerDialog()
    {
        ...
        btnCallFirst.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                GlobalVar.GV().makeCall(String.valueOf(txtFirstPhone.getText()));
            }
        });
        ...
        btnCallSecond.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                GlobalVar.GV().makeCall(String.valueOf(txtSecondPhone.getText()));
            }
        });
